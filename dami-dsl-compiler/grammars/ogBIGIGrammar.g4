...
decomposeStatement:
  DECOMPOSE_SYMBOL identifier USING_SYMBOL identifier (COMMA_SYMBOL identifier)* OPAR_SYMBOL
    (decomposedTable)*
  CPAR_SYMBOL (foreignKeyRelation)? SCOL_SYMBOL
;

decomposedTable:
  TABLE_SYMBOL identifier COL_SYMBOL 
    columnMapping (COMMA_SYMBOL (columnMapping | saveRelation))*
;
...
whereStatement:
  WHERE_SYMBOL OPAR_SYMBOL identifier DOT_SYMBOL identifier OPAR_SYMBOL identifier CPAR_SYMBOL EQUAL_SYMBOL identifier OPAR_SYMBOL identifier CPAR_SYMBOL CPAR_SYMBOL
;
...
useBIDI:
  USE_SYMBOL BIDI_SYMBOL identifier SCOL_SYMBOL
;
...
dropServer:
  SERVER_SYMBOL identifier SCOL_SYMBOL
;
...
importSchema:
  IMPORT_SYMBOL SCHEMA_SYMBOL identifier INTO_SYMBOL identifier SCOL_SYMBOL
;
